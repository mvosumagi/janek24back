...
INSERT INTO city (id, country_id, name) VALUES (default, (SELECT id FROM country WHERE name='Estonia'), 'Tallinn');
INSERT INTO city (id, country_id, name) VALUES (default, (SELECT id FROM country WHERE name='Estonia'), 'Tartu');

INSERT INTO currency (id, short_code, description) VALUES (1, 'EUR', 'Euro');
...
INSERT INTO service_category (id, name, description)
VALUES (default, 'Lawn Care', 'Landscaping, lawn maintenance, and garden services to beautify your outdoor space.');
...
INSERT INTO service_category (id, name, description)
VALUES (default, 'Pet Care', 'Pet sitting, dog walking, grooming, and veterinary transport services.');

INSERT INTO service_category (id, name, description)
VALUES (default, 'Tutoring', 'Academic support and educational tutoring for students of all ages and subjects.');

INSERT INTO service_category (id, name, description)
VALUES (default, 'Car Repair', 'Vehicle maintenance and repair services.');

INSERT INTO service_category (id, name, description)
VALUES (default, 'Sales', 'Sales assistance, lead generation, and customer outreach.');


INSERT INTO service (id, user_id, service_category_id, name, description_short, description_long, valid_from, valid_to, unit_cost, currency_is, status)
